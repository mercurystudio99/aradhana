    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                ...
                [
                    'name'  => 'admin_email',
                    'val'   => 'contact@travel.test',
                    'group' => "general",
                ], [
                    'name'  => 'email_from_name',
                    'val'   => 'Travel Proffesor',
                    'group' => "general",
                ], [
                    'name'  => 'email_from_address',
                    'val'   => 'contact@rodezweb.test',
                    'group' => "general",
                ],
                [
                    'name'  => 'logo_id',
...
<a href="mailto:contact@bookingcore.test">contact@travel.test</a>',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_left',
                    'val'   => 'Copyright © 2020 by Rodez Web Technologies',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Travel Proffersor</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
