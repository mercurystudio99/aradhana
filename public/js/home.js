...
jQuery(function ($) {
    ...
    $('.bravo-form-register [type=submit]').click(function (e) {
        ...
        $.ajax({
            ...
            'data': {
                ...
                'register_role': form.find('[name=register_role]').val(),
    ...
    $(document).on("click",".service-compare",function(){
        var $this = $(this);
        $.ajax({
            url:  bookingCore.url+'/user/compare',
            data: {
                object_id: $this.attr("data-id"),
                object_model: $this.attr("data-type"),
            },
            ...
            success: function (res) {
                $this.attr('class',"service-compare "+res.class);
                location.reload()
            },
            error:function (e) {
                if(e.status === 401){
    ...
    $(document).on("click",".btn-add-property-favorite",function(){
        ...
        $.ajax({
            ...
            success: function (res) {
                $this.attr('class',"btn-add-property-favorite "+res.class);
                console.log(res.class)
                if(res.class=="active"){
                    $('#wp-realestate-popup-message').html('<div class="message-inner alert bg-save">Add favorite successfully.</div>').fadeIn(1500,function(){
                        setTimeout(function(){$('#wp-realestate-popup-message').html('<div class="message-inner alert bg-save">Add favorite successfully.</div>').fadeOut(1500)},3000);
                    });
                    $('.icon-heart').css('background','#0061df')
                    $('.btn-add-property-favorite').attr('data-original-title','Remove Favorite')
                }else{
                    $('#wp-realestate-popup-message').html('<div class="message-inner alert bg-save">Favorite Removed</div>').fadeIn(1500,function(){
                        setTimeout(function(){$('#wp-realestate-popup-message').html('<div class="message-inner alert bg-save">Favorite Removed</div>').fadeOut(1500)},3000);
                    });
                    
                    $('.icon-heart').css('background','#F6F8F9');
                    $('.btn-add-property-favorite').attr('data-original-title','Add Favorite')
                }
            },
            error:function (e) {
                if(e.status === 401){
    ...
    $( document ).ready(function() {
        if($('.btn-add-property-favorite').hasClass('active')){
            console.log('active')
            $('.icon-heart').css('background','#0061df')
            $('.btn-add-property-favorite').attr('data-original-title','Remove Favorite')
        }else{
        ...
        if($('.btn-add-property-compare').hasClass('active')){
            console.log('active')
            
            $('.icon-plus').css('background','#0061df')
            $('.btn-add-property-compare').attr('data-original-title','Remove Compared')
        }else{
            console.log('faile')
            $('.icon-plus').css('background','#F6F8F9');
            $('.btn-add-property-compare').attr('data-original-title','Add Compare')
        }
    ...
    $(document).on("click",".btn-add-property-compare",function(){
        ...
        $.ajax({
            ...
            success: function (res) {
                $this.attr('class',"btn-add-property-compare "+res.class);
                console.log(res.class)
                if(res.class=="active"){
