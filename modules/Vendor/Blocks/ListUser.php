...
class ListUser extends BaseBlock
{
        ...
        $this->setOptions([
            'settings' => [
                ...
                [
                    ...
                    'select2'      => [
                        'ajax'     => [
                            'url'      => route('user.admin.getForSelect2',['user_type'=>'customer']),
                            'dataType' => 'json'
                        ],
                        'width'    => '100%',
                        'multiple' => "true",
    ...
    public function query($model){
        ...
        $list_user->leftjoin('core_model_has_roles','users.id','core_model_has_roles.model_id');
