    ...
    <div class="container">
        <div class="content  d-flex justify-content-between align-items-center">
            <div class="header-left ">
                ...
                <div class="bravo-menu_custom" >
                    
                </div>
            </div>
            <div class="header-right">
                    <ul class="topbar-items"> 
                        <li class='login-item' style='font-size:20px;'><?php generate_menu('primary') ?></li>
                        <li class="login-item" style='font-size:14px;color:#10174B;'><i class='fa fa-phone' ></i>{{__(' (+88)12345678')}}</li>
                        @if(!Auth::check())

                            <li class="login-item">
                                <a href="#login" data-toggle="modal" data-target="#login" class="login" style='font-size:14px;color:#10174B;'><i class='fa fa-user'></i>{{__('  Login / Register')}}</a>
                            </li>

                        @else
                            <li class="login-item dropdown">
                                <a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle is_login" style='color:#10174B;' id="navbarDrop1">
                                ...
                                <ul class="dropdown-menu text-left" role='menu' aria-labelledby="navbarDrop1">
