<div class="bravo_header">
    <div class="{{$container_class ?? 'container-fluid'}} d-flex justify-content-center align-items-center">
        <div class="content">
            ...
            <div class="header-right">
                    <ul class="topbar-items">
                        <li class="login-item" style='font-size:14px;color:white'><i class='fa fa-phone' ></i>{{__(' (+88)12345678')}}</li>
                        @if(!Auth::check())

                            <li class="login-item">
                                <a href="#login" data-toggle="modal" data-target="#login" class="login" style='font-size:14px;color:white'><i class='fa fa-user'></i>{{__('  Login / Register')}}</a>
                            </li>

                        @else
                            <li class="login-item dropdown">
                                <a href="#" data-toggle="dropdown" class="is_login" style='color:white;'>
