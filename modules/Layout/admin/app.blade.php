...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Travel Proffesor'}}</title>
...
<div id="app">
    ...
    <div class="main-sidebar" style='background-color:white !important;'>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Aradhana Administrator')}} <a href="{{__('https://www.aradhana.com')}}" target="_blank">{{__('Aradhana Company')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://www.aradhana.com')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://www.aradhana.com')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
