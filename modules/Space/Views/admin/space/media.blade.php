<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="form-group-item">
                ...
                <div class="g-items-header">
                    <div class="row">
                        ...
                        <div class="col-md-8">{{__('Content')}}</div>
        ...
        <div class='form-group'>
            <div class="form-group">
                <label class="control-label">{{__("Media Gallery")}}</label>
                {!! \Modules\Media\Helpers\FileHelper::fieldGalleryUpload('mediagallery',$row->mediagallery) !!}
            </div>
        </div>
        <div class='form-group'>
            @if(is_default_lang())
