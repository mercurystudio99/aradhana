                        ...
                        <div class="item" data-number="{{$key}}">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="">
                                            <textarea name="faqs[{{$key}}][content]" class="d-none has-ckeditor form-control" cols="20" rows="10">{{$faq['content']}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1">
                ...
                <div class="item" data-number="__number__">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="">
                                    <textarea name="faqs[__number__][content]" class="d-none has-ckeditor form-control" cols="20" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
