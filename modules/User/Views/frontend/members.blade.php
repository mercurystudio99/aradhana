...
<head>
    ...
    <link href="{{ asset('libs/bootstrap4.0/css/bootstrap.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset("css/gridcard.css") }}"/>
    <link href="{{ asset('dist/frontend/css/app.css?_ver='.config('app.asset_version')) }}" rel="stylesheet">
    <link href="{{ asset('simple-line-icons/simple-line-icons.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset("css/member.css") }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset("custom/css/components.css") }}"/>
...
<body class="frontend-page {{ !empty($row->header_style) ? "header-".$row->header_style : "header-normal" }} {{$body_class ?? ''}} @if(setting_item_with_lang('enable_rtl')) is-rtl @endif @if(is_api()) is_api @endif">
    ...
    <div class="bravo_wrap">
        ...
        @include('User::frontend.layouts.members.index')
