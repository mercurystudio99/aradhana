                ...
                <div class="form-group">
                    ...
                    <div class="upload-btn-wrapper">
                        <div class="input-group">
                            ...
                            <input type="text" data-error="{{__("Error upload...")}}" data-loading="{{__("Loading...")}}" class="form-control text-view" readonly value="{{ get_file_url( old('banner_id',$dataUser->banner_id) ) ?? $dataUser->getBannerUrl()?? __("No Image")}}">
                        </div>
                        <input type="hidden" class="form-control" name="banner_id" value="{{ old('banner_id',$dataUser->banner_id)?? ""}}">
                        <img class="image-demo" src="{{ get_file_url( old('banner_id',$dataUser->bannerid) ) ??  $dataUser->getBannerUrl() ?? ""}}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label">{{__("Gallery")}}</label>
                    {!! \Modules\Media\Helpers\FileHelper::fieldGalleryUpload('gallery',$dataUser->gallery) !!}
                </div>
                @endif
            </div>
            <div class="col-md-6">
