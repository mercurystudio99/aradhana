...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    Route::get('/members','UserController@members')->name('members'); // Search
    Route::get('/vendors','UserController@vendors')->name('vender.search'); // Search
    Route::get('/other-vendors','UserController@customers')->name('customer.search'); // Search
    ...
    Route::post('/compare','UserWishListController@handleCompare')->name("user.compare.handle");
